Ext.define('AppUI.view.invoice.TransferSerialList', {
	extend: 'Ext.List',
        ...
        items: [{
                    ...
                    items: [
                        { xtype: 'spacer' },
                       	 ...
                       	 { text:'Add',ui:'masked',
		                        handler: function(me) {
		                        	console.log("addtransferitem");
		                       	me.up('transferitemlist').onAddTransferSerial();
		                    }
         ...
         listeners: {
                ...
                itemtap: function(me, list, index, item) {
                    var me=this;
                    me.fireEvent('onViewTransferSerial', me, list, index,item);
                    console.log('transferitemLeafTap');
                } 
            	}
    		} ,
    			onAddTransferSerial:function(){
    				console.log("onAddTransferSerial");
    				this.fireEvent("onAddTransferSerial");
    			},
            	 /**
