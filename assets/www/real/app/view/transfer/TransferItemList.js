Ext.define('AppUI.view.invoice.TransferItemList', {
	extend: 'Ext.List',
        ...
        items: [{
                        ...
                        { xtype: 'spacer' },
                       	 { text:'Add',ui:'masked',
		                        handler: function(me) {
		                       	...
		                       	me.up('transferitemlist').onAddTransferItem();
		                    }
         ...
         listeners: {
                ...
                itemtap: function(me, list, index, item) {
                    var me=this;
                    me.fireEvent('onViewTransferItem', me, list, index,item);
                    console.log('transferitemLeafTap');
                } 
            	}
    		} ,
    			onAddTransferItem:function(){
    				console.log("onAddTransferItem");
    				this.fireEvent("onAddTransferItem");
    			},
            	 /**
