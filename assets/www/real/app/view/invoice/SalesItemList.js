Ext.define('AppUI.view.invoice.SalesItemList', {
	extend: 'Ext.List',
    xtype: 'salesitemlist',
    requires: [
         'Ext.data.Store',
        ...
        items: [{
                        ...
                        { xtype: 'spacer' },
                       	 { text:'Add',ui:'masked',
		                        handler: function(me) {
		                       	...
		                       	me.up('salesitemlist').onAddSalesItem();
		                    }
         ...
         listeners: {
                ...
                itemtap: function(me, list, index, item) {
                    var me=this;
                    me.fireEvent('onViewSalesItem', me, list, index,item);
                    console.log('salesitemLeafTap');
                } 
            	}
    		} ,
    			onAddSalesItem:function(){
    				console.log("onAddSalesItem");
    				this.fireEvent("onAddSalesItem");
    			},
            	 /**
