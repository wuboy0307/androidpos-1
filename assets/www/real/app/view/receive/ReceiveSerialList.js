Ext.define('AppUI.view.invoice.ReceiveSerialList', {
	extend: 'Ext.List',
    ...
    config: {
       store: 'ReceiveSerials',
       ui:'round',
       cls: 'x-customlist',
       title: 'Receive Serial',
        plugins: [
        {
        ...
        items: [{
                    ...
                    items: [
                        { xtype: 'spacer' },
                       	 ...
                       	 { text:'Add',ui:'masked',
		                        handler: function(me) {
		                        	console.log("addreceiveitem");
		                       	me.up('receiveitemlist').onAddReceiveSerial();
		                    }
         ...
         listeners: {
                ...
                itemtap: function(me, list, index, item) {
                    var me=this;
                    me.fireEvent('onViewReceiveSerial', me, list, index,item);
                    console.log('receiveitemLeafTap');
                } 
            	}
    		} ,
    			onAddReceiveSerial:function(){
    				console.log("onAddReceiveSerial");
    				this.fireEvent("onAddReceiveSerial");
    			},
            	 /**
