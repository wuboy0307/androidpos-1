Ext.define('AppUI.view.invoice.ReceiveItemList', {
	extend: 'Ext.List',
        ...
        items: [{
                        ...
                        { xtype: 'spacer' },
                       	 { text:'Add',ui:'masked',
		                        handler: function(me) {
		                       	...
		                       	me.up('receiveitemlist').onAddReceiveItem();
		                    }
         ...
         listeners: {
                ...
                itemtap: function(me, list, index, item) {
                    var me=this;
                    me.fireEvent('onViewReceiveItem', me, list, index,item);
                    console.log('receiveitemLeafTap');
                } 
            	}
    		} ,
    			onAddReceiveItem:function(){
    				console.log("onAddReceiveItem");
    				this.fireEvent("onAddReceiveItem");
    			},
            	 /**
