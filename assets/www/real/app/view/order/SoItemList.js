Ext.define('AppUI.view.invoice.SoItemList', {
	extend: 'Ext.List',
    xtype: 'soitemlist',
    requires: [
         'Ext.data.Store',
        ...
        items: [{
         ...
         listeners: {
                ...
                itemtap: function(me, list, index, item) {
                    var me=this;
                    me.fireEvent('onViewSoItem', me, list, index,item);
                    console.log('soitemLeafTap');
                } 
            	}
    		} ,
    			onAddSoItem:function(){
    				console.log("onAddSoItem");
    				this.fireEvent("onAddSoItem");
    			},
            	 /**
