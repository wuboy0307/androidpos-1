Ext.define('AppUI.view.invoice.ReturnSerialList', {
	extend: 'Ext.List',
        ...
        items: [{
                    ...
                    items: [
                        { xtype: 'spacer' },
                       	 ...
                       	 { text:'Add',ui:'masked',
		                        handler: function(me) {
		                        	console.log("addreturnitem");
		                       	me.up('returnitemlist').onAddReturnSerial();
		                    }
         ...
         listeners: {
                ...
                itemtap: function(me, list, index, item) {
                    var me=this;
                    me.fireEvent('onViewReturnSerial', me, list, index,item);
                    console.log('returnitemLeafTap');
                } 
            	}
    		} ,
    			onAddReturnSerial:function(){
    				console.log("onAddReturnSerial");
    				this.fireEvent("onAddReturnSerial");
    			},
            	 /**
