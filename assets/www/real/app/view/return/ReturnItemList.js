Ext.define('AppUI.view.invoice.ReturnItemList', {
	extend: 'Ext.List',
        ...
        items: [{
                        ...
                        { xtype: 'spacer' },
                       	 { text:'Add',ui:'masked',
		                        handler: function(me) {
		                       	...
		                       	me.up('returnitemlist').onAddReturnItem();
		                    }
         ...
         listeners: {
                ...
                itemtap: function(me, list, index, item) {
                    var me=this;
                    me.fireEvent('onViewReturnItem', me, list, index,item);
                    console.log('returnitemLeafTap');
                } 
            	}
    		} ,
    			onAddReturnItem:function(){
    				console.log("onAddReturnItem");
    				this.fireEvent("onAddReturnItem");
    			},
            	 /**
