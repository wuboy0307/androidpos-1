...
Ext.define('Ext.data.proxy.WebStorage', {
    ...
    getRecord: function(id) {
    	...
    	console.log(this.getRecordKey(id));
    	console.log("***below is getItem()******");
    		console.log(this.getStorageObject().getItem(this.getRecordKey(id)));
    			console.log("*************************************");
    ...
    setRecord: function(record, id) {
    	console.log("****setRecord "+record+":"+id);
    	console.log(record);
    	console.log(id);
    	console.log("*************************************");
        if (id) {
     ...
     */
    getIds: function() {
    	console.log("***getIds().getItem() :"+this.getStorageObject().getItem(this.getId()));
    ...
    initialize: function() {
        this.callParent(arguments);
      //  console.log("***initialize :"+this.getId()+":"+ storageObject.getItem(this.getId()) );
