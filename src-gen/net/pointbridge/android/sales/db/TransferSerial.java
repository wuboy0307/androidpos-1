...
/**
 * Entity mapped to table TRANSFER_SERIAL.
 */
public class TransferSerial {
    ...
    public TransferSerial(String ts_id) {
        this.ts_id = ts_id;
    }

    public TransferSerial(String ts_id, String td_id, String tm_id, String itm_code, String serial_no, String src_code, Integer no_seq, Integer astate, Integer locked, Integer posted, Integer mark, String modi_by, java.util.Date modi_date) {
        this.ts_id = ts_id;
        this.td_id = td_id;
        this.tm_id = tm_id;
